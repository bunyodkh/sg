    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_type', models.CharField(choices=[('investor', 'Investor'), ('support_organization', 'Support Organization')], default='investor', help_text='Organization Type', max_length=50, verbose_name='Organization Type')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('investor_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='investors', to='registry.investortype', verbose_name='Type')),
        ...
        migrations.AddField(
            model_name='startup',
            name='categories',
            field=models.ManyToManyField(blank=True, related_name='startups', to='registry.startupcategory', verbose_name='Categories'),
        ),
        migrations.CreateModel(
            name='SupportProgram',
            fields=[
